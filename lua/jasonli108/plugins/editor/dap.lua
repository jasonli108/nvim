...
return {
	...
	config = function(_, opts)
		...
		local dapui = require("dapui") -- localize for ease of use
		dapui.setup(opts)

		-- STATE TRACKING FOR MAXIMIZE
		local maximized = false

		-- Create a global-ish function so the keymap can access the state
		_G.toggle_dap_maximize = function()
	...
	keys = {
		{
			"<leader>dz",
			function()
				_G.toggle_dap_maximize()
			end,
			desc = "DAP: Maximize/Restore Window",
		},
		{
			"<leader>db",
			function()
